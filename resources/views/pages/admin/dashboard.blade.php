                            ...
                            <div class="row align-items-center">
                                <div class="col-xl-8 col-xxl-12">
                                    <div class="text-center text-xl-start text-xxl-center mb-4 mb-xl-0 mb-xxl-4">
                                        <h1 class="text-primary">Selamat Datang di Website {{ $app->name ?? 'Default App Name' }} !</h1>
                                        <p class="text-gray-700 mb-0">{{ $app->title }} </p>
                                    </div>
                                </div>
                ...
                <div class="col-lg-6 col-xl-4 mb-4">
                    <div class="card bg-warning text-white h-100">
                        ...
                        <div class="card-footer d-flex align-items-center justify-content-between small">
                            <a class="text-white stretched-link" href="{{ route('post.index') }}">Selengkapnya</a>
                ...
                <div class="col-lg-6 col-xl-4 mb-4">
                    <div class="card bg-success text-white h-100">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="me-3">
                                    <div class="text-white-75 small">Foto</div>
                                    <div class="text-lg fw-bold">{{ $photo }}</div>
                                </div>
                                <i class="feather-xl text-white-50" data-feather="camera"></i>
                            </div>
                        </div>
                        <div class="card-footer d-flex align-items-center justify-content-between small">
                            <a class="text-white stretched-link" href="{{ route('photo.index') }}">Selengkapnya</a>
                            <div class="text-white"><i class="fas fa-angle-right"></i></div>
                        </div>
                    </div>
                </div>
