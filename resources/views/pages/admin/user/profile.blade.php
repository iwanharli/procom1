    ...
    <main>
        ...
        <div class="container-xl px-4 mt-4">
            ...
            <nav class="nav nav-borders">
                <a class="nav-link {{ (request()->is('admin/users/user/profile')) ? 'active ms-0' : '' }}" href="{{ route('profile-user') }}">Profil</a>
                <a class="nav-link {{ (request()->is('admin/users/user/profile/password')) ? 'active ms-0' : '' }}" href="{{ route('change-password') }}">Ubah Password</a>
            </nav>
            <hr class="mt-0 mb-4" />
            <div class="row">
                <div class="col">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('profile-update', $user->id) }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" name="roles" type="text" value="{{ $user->roles }}" readonly/>
                                </div>
                                <!-- Save changes button-->
